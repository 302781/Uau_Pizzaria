...
Integrantes: Lucas Braz e Maria Vitória  
...
Justificativa (descreva o que vocês fizeram e por que): Com o passar do desenvolvimento deixamos os componentes mais bem desenvolvidos e bem implantados. 
...
Justificativa (descreva os recursos de acessibilidade implementados): Barra animada mostrando visualmente os exemplos dos nossos produtos.  
...
Justificativa (descreva os testes realizados e ajustes feitos): Testes feitos em formatos desktop mas se quebrando em tablets em formato 375px. 
...
Justificativa (descreva como vocês organizaram o código): entre tabelas estruturas nos códigos HTML e CSS. 
...
Justificativa (descreva as escolhas de cores, tipografia e identidade visual): A logo/Banner é mais puxado pro escuro e minimalista então seguimos a ideia. 
...
Justificativa (descreva como vocês organizaram visualmente o conteúdo): hierarquia entre tabelas e componentes mais importantes  
...
Justificativa (descreva como melhoraram a experiência do usuário): Imagem da logo menor e introduzir nossa lista de produtos. 
...
Justificativa (descreva como o design reflete o negócio escolhido): Algo minimalista e escuro como em sites de churrasco e outras pizzarias. 
...
Usabilidade             | 5 | 8 | 
Alinhamento com Negócio | 6 | 8 | 
Subtotal Estético       | 20 | 32 | 
TOTAL GERAL             | 38 | 64 | 
...
Possuí um bom layout para um site gastronômico. 
...
Critério 1: A imagem da logo não se adapta aos formatos de tela  
